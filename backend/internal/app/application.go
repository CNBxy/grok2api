...
func New(ctx context.Context, cfg config.Config, logger *slog.Logger) (*Application, error) {
	...
	accountService.SetOperationLogRepository(relational.NewAccountOperationLogRepository(database))
