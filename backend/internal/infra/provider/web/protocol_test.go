...
func TestCatalogMatchesSupportedSurface(t *testing.T) {
	...
	for _, required := range []string{"grok-chat-fast", "grok-chat-auto", "grok-chat-expert", "grok-chat-heavy", "grok-imagine-image-2.0", "grok-imagine-image-quality-2.0", "grok-imagine-image-edit", "imagine-x-1", "grok-imagine-video"} {
