...
import { DeferredAccountRefreshRecordsPage, DeferredAccountsPage, DeferredApiDocsPage, DeferredAppShell, DeferredClientKeysPage, DeferredCreativeConsolePage, DeferredDashboardPage, DeferredGalleryPage, DeferredModelsPage, DeferredQualityGuardPage, DeferredRequestAuditsPage, DeferredSettingsPage, DeferredVideoGalleryPage } from "@/app/deferred-pages";
    ...
    children: [
      {
        ...
        children: [
          ...
          { path: "/account-refresh-records", element: <DeferredAccountRefreshRecordsPage /> },
