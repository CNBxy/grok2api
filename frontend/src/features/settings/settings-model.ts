...
export const settingsSchema = z.object({
  ...
  routing: z.object({
    ...
    preferResidentialEgress: z.boolean(),
  ...
  accounts: z.object({
    ...
    excludeRecentDegradeAccountsFromScheduling: z.boolean(),
...
export function toSettingsForm(config: SettingsConfigDTO): SettingsForm {
  return {
    ...
    routing: {
      ...
      preferResidentialEgress: config.routing.preferResidentialEgress,
    ...
    accounts: {
      ...
      excludeRecentDegradeAccountsFromScheduling: config.accounts.excludeRecentDegradeAccountsFromScheduling,
