        ...
        <Tabs defaultValue="build" className="flex min-w-0 flex-col gap-7 lg:flex-row lg:items-start">
          ...
          <SettingsSection title={t("settings.routing.title")}>
            <div className="space-y-0">
              ...
              <SettingsField controlId="routing-prefer-residential-egress" label={t("settings.routing.preferResidentialEgress")} description={t("settings.routing.preferResidentialEgressHelp")}><Controller control={form.control} name="routing.preferResidentialEgress" render={({ field }) => <div className="flex h-9 items-center"><Switch id="routing-prefer-residential-egress" checked={Boolean(field.value)} onCheckedChange={field.onChange} /></div>} /></SettingsField>
