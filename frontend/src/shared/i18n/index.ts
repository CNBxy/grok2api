...
Object.assign(resources.en.translation.settings.egress as unknown as Record<string, string>, {
  ...
  importDialogDescription: "Supports plain-text, Base64, or YAML (mihomo/Clash) proxy lists; plain text accepts one HTTP, SOCKS, Trojan, VLESS, SS, or VMess address per line.",
