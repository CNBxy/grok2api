...
const resources = {
  "zh-CN": {
    translation: {
      ...
      accountRefreshRecords: {
        title: "账号刷新记录",
        description: "查看额度同步与凭据刷新的最近结果与历史。",
        quotaSync: "额度同步",
        credentialRefresh: "凭据刷新",
        credentialRefreshHint: "凭据刷新目前仅支持 Grok Build。",
        providers: {
        ...
        historyDescription: "默认显示最近一次，可点选查看更早记录（最多 20 条）。",
        noHistory: "暂无历史记录",
        retry: "重新执行",
        syncQuota: "额度同步",
        refreshCredentials: "凭据刷新",
      },
      creativeConsole: {
        title: "创作控制台",
      ...
      settings: {
        ...
        accounts: {
          ...
          excludeRecentDegradeAccountsFromScheduling: "近 7 天降智账号移出调度",
          excludeRecentDegradeAccountsFromSchedulingHelp: "开启后，请求选号时自动跳过近 7 天降智统计命中的 Build 账号，以及质量守护已禁用出口节点上的号池。账号不会被改成停用，只是当次请求不选用；阈值与质量守护 softTPS/hardTPS 一致。",
          cleanupTitle: "账号清理",
  ...
  en: {
    translation: {
      ...
      nav: { dashboard: "Dashboard", accounts: "Accounts", accountRefreshRecords: "Account refresh records", models: "Models", clientKeys: "Client keys", creativeConsole: "Creative console", gallery: "Gallery", videoGallery: "Video Gallery", audits: "Request audits", qualityGuard: "Quality guard", docs: "Documentation", settings: "Settings" },
      accountRefreshRecords: {
        title: "Account refresh records",
        description: "Inspect the latest quota sync and credential refresh outcomes with history.",
        quotaSync: "Quota sync",
        credentialRefresh: "Credential refresh",
        credentialRefreshHint: "Credential refresh currently supports Grok Build only.",
        providers: {
          grok_build: "Grok Build",
          grok_web: "Grok Web",
          grok_console: "Grok Console",
        ...
        history: "History",
        historyTitle: "History for {{name}}",
        historyDescription: "Shows the latest entry by default. Select earlier rows to inspect up to 20 records.",
